function run_experiments_4()
  ...
  bcnnvdm.opts = {...
    'type', 'bcnn', ...
    'modela', 'data/bcnn-train-vdm-f2-resize448/cub-seed-01/fine-tuned-model/final-model-neta.mat', ...
    'layera', 30,...
    'modelb', 'data/bcnn-train-vdm-f2-resize448/cub-seed-01/fine-tuned-model/final-model-netb.mat', ...
    'layerb', 14,...
    'normalization', 'sqrt_L2'
    } ;
  ...
  bcnnvdvd.opts = {...
    'type', 'bcnn', ...
    'modela', 'data/bcnn-train-dd-f2-keepap/cub-seed-01/fine-tuned-model/final-model.mat', ...
    'layera', 30,...
    'modelb', 'data/bcnn-train-dd-f2-keepap/cub-seed-01/fine-tuned-model/final-model.mat', ...
    'layerb', 30,...
    };
    ...
    for jj = 1 : numSplits
      for ee = 1: numel(encoderList)
        model_train(...
          ...
          'prefix', 'bcnn-ft-vdm-f2-resize448', ...
