function tryLogisticRegression
...
% opts.train.learningRate = [0.5*ones(1, 150), 0.05*ones(1, 100), 0.01*ones(1, 50)];;
opts.train.learningRate = [0.5*ones(1, 1000), 0.05*ones(1, 100), 0.01*ones(1, 50)];;
...
initialW = 0.01/scal *randn(bi_d, numClass,'single');
...
[net, info] = cnn_train(net, bcnndb, @getBatch_bcnn, opts.train, ...
    ...
    'momentum', 0.5, 'expDir', fullfile(featPath, 'init_small_momentum'));
