function code= get_pvcnn_features(net, im, varargin)
% GET_PVCNN_FEATURES  Get pvcnn features for an image
...
if isDag
    ...
    assert(~isempty(idx), 'no gsp layer')
    if strcmp(net.layers{idx}.type, 'gsp')
