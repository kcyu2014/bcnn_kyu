function run_experiments()
  ...
  bcnnvdm.opts = {...
    'type', 'bcnn', ...
    'modela', 'data/bcnn-train-vdm-f2-resize448-keepap/cub-seed-01/fine-tuned-model/final-model-neta.mat', ...
    'layera', 30,...
    'modelb', 'data/bcnn-train-vdm-f2-resize448-keepap/cub-seed-01/fine-tuned-model/final-model-netb.mat', ...
    'layerb', 14,...
    'normalization', 'sqrt_L2'
    } ;
    ...
    for jj = 1 : numSplits
      for ee = 1: numel(encoderList)
        model_train(...
          ...
          'prefix', 'bcnn-ft-vdm-f2-resize448-keepap', ...
