...
%% bilinear pooling CNN
 ...
 % layers
  ...
  bcnnmmft.opts = {...
    'type', 'bcnn', ...
    'modela', 'data/checkgpu/cub-seed-01/fine-tuned-model/final-model.mat', ...
    'layera', [],...
    'modelb', [], ...
    'layerb', []
    } ;
  ...
  bcnnvdmft.opts = {...
    'type', 'bcnn', ...
    'modela', 'data/checkgpuvd/cub-seed-01/fine-tuned-model/final-model.mat', ...
    'layera', [],...
    'modelb', [], ...
    'layerb', []
    } ;
  ...
  bcnnvdvdft.opts = {...
    'type', 'bcnn', ...
    'modela', 'data/workon-dd/cub-seed-01/fine-tuned-model/final-model.mat', ...
    'layera', [],...
    'modelb', [], ...
    'layerb', [],...
    };
    ...
    for jj = 1 : numSplits
      for ee = 1: numel(encoderList)
        ...
        model_train(...
          ...
          'prefix', 'exp-ft', ...              % name of the output folder
