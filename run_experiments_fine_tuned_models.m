function run_experiments_fine_tuned_models()
  ...
  bcnnvdm.opts = {...
    'type', 'bcnn', ...
    'modela', 'data/bcnn-train-vdm-scale1/cub-seed-01/fine-tuned-model/final-model-neta.mat', ...
    'layera', 30,...
    'modelb', 'data/bcnn-train-vdm-scale1/cub-seed-01/fine-tuned-model/final-model-netb.mat', ...
    'layerb', 14,...
    } ;
    ...
    for jj = 1 : numSplits
      for ee = 1: numel(encoderList)
        model_train(...
          ...
          'prefix', 'bcnn-train-fine-tuned-vdm-scale1', ...
